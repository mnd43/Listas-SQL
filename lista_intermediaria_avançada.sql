...
/* 1️⃣ Cria a CTE morethan5, juntando consumidores e cidades. 2️⃣ Usa a CTE para contar consumidores por cidade (COUNT(*) AS cidade_p5). 3️⃣ Filtra cidades com mais de 5 consumidores (HAVING COUNT(*) > 5). 4️⃣ Ordena os resultados do maior para o menor (ORDER BY cidade_p5 DESC).
*/
